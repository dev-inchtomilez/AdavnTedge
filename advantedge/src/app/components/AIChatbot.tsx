...
export function AIChatbot() {
  ...
  const processResponse = (response: string) => {
    if (currentStep === "name") {
      ...
      let score = 50;
      if (
        leadData.purposeOfEnquiry.includes("Quote") ||
        leadData.purposeOfEnquiry.includes("Consultation")
      ) {
        score += 30;
      }
      ...
      setTimeout(() => {
        ...
        if (
          ...
          lowerResponse.includes("timeline") ||
  ...
  const saveLead = (data: typeof leadData, score: number) => {
    ...
    if (score >= 70) {
      const priorityLeads = JSON.parse(
        localStorage.getItem("priority_leads") || "[]",
      );
  ...
  return (
    <>
      ...
      {isOpen && (
        <div
          className={`chatbot-window ${isOpen ? "chatbot-window-open" : ""} ${
            isMinimized ? "chatbot-window-minimized" : ""
          }`}
        >
          {/* Header */}
              ...
              <div className="chatbot-messages">
                ...
                {isTyping && (
                  <div className="chatbot-message chatbot-message-bot">
                    <div
                      className="chatbot-bubble chatbot-bubble-bot"
                      style={{ borderColor: colors.brand.secondary + "40" }}
                    >
      ...
      <style>{`
        ...
        .chatbot-header-content > div:last-child {
          min-width: 0;
        }
        ...
        .chatbot-input-container {
          ...
          border-top: 1px solid ${colors.brand.secondary}40;
          background: white;
        }
        ...
        .chatbot-input:focus {
          ...
          box-shadow: 0 0 0 3px ${colors.brand.secondary}18;
        }
        ...
        @media (max-width: 480px) {
          ...
          .chatbot-window {
            ...
            height: min(430px, calc(100svh - 20px));
