...
{
  /*
  DEPENDENCY-SAFE DROP-IN SECTION

  This upgraded hero intentionally uses only the exact dependencies already
  proven to work in the original Home.tsx hero:

  ModernSectionBackground, Container, motion, GlowEffect, Sparkles,
  MagneticButton, Link, ArrowRight, AnimatedCounter, ParticleGlobe,
  colors and gradients.

  Do not add a new PageBackground import, lazy import, icon library,
  animation package or alternate ParticleGlobe component for this section.
*/
}

<ModernSectionBackground
  variant="image-overlay-office"
  className="mega-home-hero relative isolate min-h-[90svh] w-full overflow-x-clip lg:h-[90svh] lg:min-h-0 lg:overflow-hidden"
>
  {/* ============================================
  ...
  <style>
    {`
      .mega-home-hero .mega-bg-slide {
        ...
        animation: megaHeroBackground 32s ease-in-out infinite;
  ...
  >
    ...
    <div
      ...
      style={{
        background:
          "linear-gradient(90deg, rgba(7,8,18,0.84) 0%, rgba(7,8,18,0.70) 35%, rgba(7,8,18,0.38) 63%, rgba(7,8,18,0.52) 100%)",
      }}
    />
      ...
      <div className="relative mx-auto w-full max-w-7xl">
        ...
        >
          ...
          >
            ...
            <div className="relative z-10 p-4 sm:p-5 lg:p-5 xl:p-6">
              {/* Badge */}
              ...
              <h1
                className="
                  mb-2
                  max-w-[680px]
                  text-[clamp(1.65rem,3.3vw,2.75rem)]
                  font-bold
                  leading-[1.04]
                  tracking-[-0.04em]
                "
              ...
              >
                ...
                <span className="relative inline-block whitespace-nowrap">
                  ...
                  <motion.span
                    aria-hidden="true"
                    className="absolute bottom-[0.08em] left-0 z-0 h-[0.18em] rounded-full"
                    style={{
                      backgroundColor: colors.brand.accent,
                      opacity: 0.3,
                    }}
              ...
              <div className="mb-3 space-y-1.5">
                ...
                <p className="max-w-[610px] text-[13px] leading-relaxed text-gray-700">
          ...
          >
            ...
            >
              <span
                ...
                style={{
                  backgroundColor: colors.brand.accent,
                  boxShadow: `0 0 18px ${colors.brand.accent}`,
                }}
              />
            </div>
            ...
            <div className="absolute inset-0 z-20 flex items-center justify-center">
              <div className="origin-center scale-[0.52] sm:scale-[0.68] lg:scale-[0.76] xl:scale-[0.82]">
                <ParticleGlobe
                  width={450}
                  height={450}
                  particleCount={1200}
  ...
  <div
    ...
    style={{
      background: "linear-gradient(to bottom, transparent, rgba(8,9,21,0.70))",
    }}
  />
</ModernSectionBackground>;
...
<ModernSectionBackground
  variant="image-overlay-office"
  className="mega-home-hero relative isolate min-h-[calc(100svh-72px)] w-full overflow-x-clip"
>
  {/* ============================================
      SELF-CONTAINED HERO ANIMATIONS
      ============================================ */}
      ...
      <div className="relative mx-auto w-full max-w-7xl">
        ...
        >
            ...
            <div className="relative z-10 p-5 sm:p-6 lg:p-7 xl:p-8">
              ...
              <h1
                className="
                  mb-3
                  max-w-[680px]
                  text-[clamp(1.8rem,4.5vw,3.4rem)]
                  font-bold
                  leading-[1.04]
                  tracking-[-0.04em]
                "
          ...
          >
            ...
            <div className="absolute inset-0 z-20 flex items-center justify-center">
              <div className="origin-center scale-[0.52] sm:scale-[0.74] lg:scale-[0.84] xl:scale-[0.92]">
                <ParticleGlobe
                  width={450}
                  height={450}
                  particleCount={1200}
