...
{/* ============================================
    2. CORE SERVICES — CONNECTED GROWTH SYSTEM
============================================ */}
...
>
  <Section
    ...
    className="core-services-v2 relative isolate overflow-hidden"
  >
    {/* ============================================
    ...
    <style>
      {`
        .core-services-v2 .service-system-card {
          transition:
        ...
        .core-services-v2 .service-system-card:hover {
          transform: translateY(-9px);
          border-color: rgba(0, 0, 170, 0.22);
          box-shadow:
            0 34px 90px rgba(0, 1, 49, 0.16),
            0 14px 34px rgba(0, 0, 170, 0.06);
        }

        .core-services-v2 .service-system-image {
          transition:
        ...
        .core-services-v2 .service-system-accent {
        ...
        .core-services-v2
          .service-system-card:hover
          .service-system-accent {
          transform: scaleX(1);
        }

        .core-services-v2 .service-system-icon {
          transition:
            transform 0.4s cubic-bezier(0.22, 1, 0.36, 1),
            background-color 0.35s ease,
        ...
        .core-services-v2 .service-system-arrow {
          transition:
        ...
        .core-services-v2
          .service-system-card:hover
          .service-system-arrow {
          transform: translateX(5px);
        }

        .core-services-v2 .service-list-item {
          transition:
            transform 0.3s ease,
            color 0.3s ease;
        }
    ...
    >
      <img
        ...
        loading="lazy"
        decoding="async"
        className="absolute right-0 top-0 h-full w-[56%] object-cover opacity-[0.045] grayscale"
      />

      <div className="absolute inset-0 bg-gradient-to-r from-[#f7f8fc] via-[#f7f8fc]/96 to-[#f7f8fc]/82" />

      <div
        className="absolute -left-52 top-10 h-[500px] w-[500px] rounded-full opacity-[0.06] blur-[160px]"
        style={{ backgroundColor: colors.brand.secondary }}
      />

      <div
        className="absolute -right-48 bottom-[-150px] h-[490px] w-[490px] rounded-full opacity-[0.12] blur-[160px]"
        style={{ backgroundColor: colors.brand.accent }}
      />
    ...
    <Container size="xl">
      <div className="relative mx-auto max-w-7xl">
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-3xl">
              ...
              <p className="mt-5 max-w-2xl text-sm leading-[1.8] text-gray-600 sm:text-base">
                Most agencies manage isolated activities. AdvantEdge connects
                strategy, marketing execution, CRM, automation, data, and AI
            ...
            <div className="max-w-sm rounded-2xl border border-gray-200 bg-white/85 px-5 py-4 shadow-[0_16px_45px_rgba(0,1,49,0.07)] backdrop-blur-xl">
              ...
              <p
                ...
                style={{ color: colors.brand.primary }}
              >
                Strategy defines the direction. Integrated marketing creates
                demand. AI improves speed, intelligence, and conversion.
              </p>
            </div>
          </div>
        </ScrollReveal>
              ...
              {[
                {
                  ...
                  text: "Positioning, priorities, audiences, and growth strategy.",
                },
                {
                  number: "02",
                  title: "Connect the Execution",
                  text: "Channels, content, media, CRM, and customer journeys.",
                },
                {
                  number: "03",
                  title: "Accelerate the System",
                  text: "AI, automation, intelligence, and revenue optimization.",
                },
              ].map((item, index) => (
                <motion.div
                  key={item.number}
        ...
        {/* ============================================
            CORE SERVICE CARDS
        ============================================ */}
        <StaggerContainer className="mt-7 grid gap-5 lg:grid-cols-3">
          {coreServices.map((service, index) => {
            const serviceImages = [
              "https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&w=1500&q=92",
              "https://images.unsplash.com/photo-1556761175-b413da4baf72?auto=format&fit=crop&w=1500&q=92",
              "https://images.unsplash.com/photo-1551288049-bebda4e38f71c?auto=format&fit=crop&w=1500&q=92",
            ];
            ...
            return (
              ...
              >
                <Link
                  ...
                  className="block h-full outline-none focus-visible:ring-2 focus-visible:ring-[#ffb300] focus-visible:ring-offset-4"
                >
                  <article className="service-system-card group relative flex h-full min-h-[720px] flex-col overflow-hidden rounded-[26px] border border-gray-200 bg-white shadow-[0_20px_60px_rgba(0,1,49,0.09)]">
                    {/* ============================================
                        IMAGE HEADER
                    ============================================ */}
                    <div className="relative h-[260px] overflow-hidden">
                      <OptimizedImage
                        ...
                        className="service-system-image absolute inset-0 h-full w-full object-cover object-center"
                      />

                      <div className="absolute inset-0 bg-gradient-to-b from-black/5 via-black/10 to-[#000131]/88" />

                      <div className="absolute inset-0 bg-gradient-to-r from-[#000131]/36 via-transparent to-transparent" />

                      {/* Animated top accent */}
                      <div
                        aria-hidden="true"
                        className="service-system-accent absolute left-0 top-0 z-20 h-1 w-full"
                        style={{ background: gradients.primary }}
                      />

                      {/* Card number */}
                      <span className="absolute right-4 top-4 rounded-full border border-white/25 bg-black/20 px-3 py-1.5 text-[9px] font-bold tracking-[0.16em] text-white backdrop-blur-xl">
                        {String(index + 1).padStart(2, "0")}
                      </span>

                      {/* Icon */}
                      <div
                        className="service-system-icon absolute left-5 top-5 flex h-12 w-12 items-center justify-center rounded-xl border border-white/25 bg-black/20 text-white shadow-xl backdrop-blur-xl"
                      >
                        {service.icon}
                      </div>
                      ...
                      <div className="absolute inset-x-0 bottom-0 p-5 sm:p-6">
                        ...
                        <h3 className="mt-2 text-xl font-bold leading-[1.15] tracking-[-0.025em] text-white sm:text-2xl">
                          {service.title}
                        </h3>
                      </div>
                    </div>
                    ...
                    <div className="relative flex flex-1 flex-col p-5 sm:p-6">
                      ...
                      <div
                        aria-hidden="true"
                        className="absolute -right-20 -top-20 h-48 w-48 rounded-full opacity-[0.055] blur-[75px] transition-opacity duration-500 group-hover:opacity-[0.13]"
                        style={{ backgroundColor: colors.brand.secondary }}
                      />

                      <div className="relative z-10 flex h-full flex-col">
                        <p
                          className="text-xs font-bold italic leading-[1.65]"
                          style={{ color: colors.brand.secondary }}
                        >
                          {service.introLine}
                        </p>
                        ...
                        <div className="mt-5 border-t border-gray-200 pt-5">
                          ...
                          <ul className="mt-4 space-y-2.5">
                            {service.services.map((item, itemIndex) => (
                              <li
                                key={`${service.sectionId}-${itemIndex}`}
                                className="service-list-item flex items-start gap-2.5 text-[11px] leading-[1.55] text-gray-600"
                              >
                                <span
                          ...
                          <div className="flex items-center justify-between border-t border-gray-200 pt-5">
                            <div>
                              ...
                              <p className="mt-1 text-[10px] text-gray-400">
                                View strategy, scope, and outcomes
                              </p>
                            </div>

                            <div
                              className="flex h-10 w-10 items-center justify-center rounded-full border transition-colors duration-300 group-hover:border-[#ffb300]/35 group-hover:bg-[#ffb300]/10"
                              style={{
                                borderColor: `${colors.brand.secondary}18`,
                                color: colors.brand.secondary,
                              }}
                            >
                              <ArrowRight className="service-system-arrow h-4 w-4" />
                            </div>
                          </div>
                        </div>
                      </div>
        ...
        <ScrollReveal delay={0.18}>
          <div
            className="mt-7 overflow-hidden rounded-[24px] shadow-[0_24px_70px_rgba(0,1,49,0.16)]"
            ...
            <div className="grid items-center gap-0 lg:grid-cols-[0.72fr_1.28fr]">
              ...
              <div className="border-b border-white/15 px-5 py-6 sm:px-7 lg:border-b-0 lg:border-r">
                ...
                <h3 className="mt-2 text-xl font-bold leading-[1.25] tracking-[-0.025em] text-white">
                  Growth improves when every capability supports the same
                ...
                {[
                  {
                    number: "01",
                    title: "Strategy",
                    text: "Defines where to compete and how to grow.",
                  },
                  {
                    number: "02",
                    title: "Execution",
                    text: "Turns direction into coordinated market activity.",
                  },
                  {
                    number: "03",
                    title: "Intelligence",
                    text: "Improves decisions, efficiency, and conversion.",
                  },
                ].map((item, index) => (
                  <motion.div
                    key={item.number}
          ...
          <div className="mt-6 flex flex-col items-start justify-between gap-5 rounded-2xl border border-gray-200 bg-white/85 px-5 py-5 shadow-[0_16px_50px_rgba(0,1,49,0.07)] backdrop-blur-xl sm:flex-row sm:items-center sm:px-7">
            <div>
              ...
              <p
                ...
                style={{ color: colors.brand.primary }}
              >
                Start with the business challenge. We will identify the right
                combination of strategy, execution, and AI.
              </p>
            </div>

            <Link
              to="/contact"
              className="group inline-flex shrink-0 items-center justify-center rounded-xl px-5 py-3 text-sm font-bold text-white shadow-[0_14px_35px_rgba(0,0,170,0.20)] transition-all duration-300 hover:-translate-y-0.5"
              style={{ background: gradients.primary }}
            >
